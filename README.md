...
| <a name="input_additional_iam_policy_arns"></a> [additional\_iam\_policy\_arns](#input\_additional\_iam\_policy\_arns) | A list of IAM managed policy ARNs to add to the instances in adition to the default. Default allows SSM | `list(string)` | `[]` | no |
